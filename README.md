wiserfirst's vimrc based on vgod's work
============
Original Author: Tsung-Hsiang (Sean) Chang <vgod@vgod.tw>

Forked By wiserfirst <wiserfirst AT gmail DOT com>

Fork me on GITHUB  https://github.com/wiserfirst/vimrc.
...
Use curl (for Mac OS X):
     ...
     curl -o - https://raw.github.com/wiserfirst/vimrc/master/auto-install.sh | sh

or wget (for most UNIX platforms):

     wget -O - https://raw.github.com/wiserfirst/vimrc/master/auto-install.sh | sh
...
1. Check out from github
        ...
        git clone git://github.com/wiserfirst/vimrc.git ~/.vim
        cd ~/.vim
...
1. Check out from github
        ...
        git clone git://github.com/wiserfirst/vimrc.git vimfiles
        git submodule update --init
